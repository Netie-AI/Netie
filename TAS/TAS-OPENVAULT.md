...
**Shipped enough to test:** vault, gate refuse paths, FreeRoute metering/tests, 8 sorts on `main` (9th-15th sorts plus 4 execution-shape contracts in `docs/patches/`, 73 tests passed here, push 403), Pages adapter code, Next UI, Electron shell, NVMe library, CI.
