...
| Leave-machine on Space AI path | Space | Repo not in this environment. Portable `may_preview` / `ocr_cloud` refuse secrets and Baidu-on-poor-OCR. |
