...
- Constructor clone: `node --test tests/compiler.test.cjs` -> 14 passed after constructor-compiler-tests, empty-graph, ir-refuse, ir-ids, and ghost-refuse patches. Sibling push 403. Default **pages.yml** green; no `test.yml` on HEAD.
