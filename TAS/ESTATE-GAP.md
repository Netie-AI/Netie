...
- Constructor clone: `node --test tests/compiler.test.cjs` -> 19 passed after constructor-compiler-tests, empty-graph, ir-refuse, ir-ids, ghost-refuse, ir-emit, and tool-action patches. Sibling push 403. Default **pages.yml** green; no `test.yml` on HEAD.
