...
- Constructor clone: `node --test tests/compiler.test.cjs` -> 9 passed after constructor-compiler-tests, empty-graph, and ir-refuse patches. Sibling push 403. Default **pages.yml** green; no `test.yml` on HEAD.
