...
Updated: 2026-08-22 20:44 MYT. Success = live Stripe charge, then a payout.
...
- Megah: sent, no bounce yet.
- Hoe Leong `hoeleongmfg@gmail.com`: first mail + public-facts draft sent (`1a0297daed3b5ec8`).
  Email is on live homepage and services header. Services page still says Coming Soon.
  Draft: https://litter.catbox.moe/hz96oc.html
...
4. Agent next: Nursery U Garden services page still says Coming Soon
   (https://www.nurseryugarden.com.my/index.php?ws=servicesbycat).
   Last seen email on that page: nug.garden@gmail.com. Re-verify before mailing.
