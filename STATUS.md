...
- Sibling push 403: patches in `docs/patches/`. Constructor compiler **6 passed**. OpenVault `62bb1c7` + routing patches through `reset-window`: strategy tests **18 passed** (13 of 19). C2/MIN_TESTS stand. No Cortex #42.
