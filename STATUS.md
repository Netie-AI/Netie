...
- Sibling push 403: patches in `docs/patches/`. Constructor compiler **6 passed**. OpenVault: 15 sorts + 4 execution shapes. `/v1` fail-closes fusion (not a key walk). Strategy+shape+chat **43 passed**. C2/MIN_TESTS stand. No Cortex #42.
