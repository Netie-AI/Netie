...
- Product specs: DMS Space ACL (row copy, declared-table abstain), AirGPT table chunks (extra cells dropped), Pointer unlabeled / secret-field click, Space leave-machine (`user.env` refused), Control board view.
