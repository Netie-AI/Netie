...
- Sibling push 403: patches in `docs/patches/`. Constructor compiler **6 passed**. OpenVault: 15 sorts + 4 execution shapes. `/v1` last hop may SSE; context-relay uses caller available/handoff. Tests **62 passed**. C2/MIN_TESTS stand. No Cortex #42.
