...
- Sibling push 403: patches in `docs/patches/`. Constructor compiler **6 passed**. OpenVault routing patches through `cache-optimized`: strategy tests **22 passed** (15 of 19). C2/MIN_TESTS stand. No Cortex #42.
