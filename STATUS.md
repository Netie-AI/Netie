...
- Sibling push 403: patches in `docs/patches/`. Constructor compiler **9 passed**. OpenVault: 15 sorts + 4 execution shapes. `/v1` last-hop usage is measured, not a reservation. Tests **65 passed**. C2/MIN_TESTS stand. No Cortex #42.
