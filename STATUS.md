...
- Sibling push 403: patches in `docs/patches/`. Constructor compiler **6 passed**. OpenVault routing patches through `reset-aware`: strategy tests **20 passed** (14 of 19). C2/MIN_TESTS stand. No Cortex #42.
