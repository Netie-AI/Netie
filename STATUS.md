...
- Sibling push 403: patches in `docs/patches/`. Constructor compiler **6 passed**. OpenVault: 15 sorts + 4 execution shapes. `/v1` hop-walk classifies like the key walk (429 park, OPEN skip). Tests **53 passed**. C2/MIN_TESTS stand. No Cortex #42.
