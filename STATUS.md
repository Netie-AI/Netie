...
- Sibling push 403: patches in `docs/patches/`. Constructor compiler **6 passed**. OpenVault: 15 sorts + 4 execution shapes. `/v1` nameless fusion 400; `combo.models` sequential hop-walk. Tests **47 passed**. C2/MIN_TESTS stand. No Cortex #42.
