...
Updated: 2026-08-22 20:35 MYT. Success = live Stripe charge, then a payout.
...
- Fabritex: sent, no bounce yet.
- Energy Option `energyoption3368@gmail.com`: first mail + public-facts draft sent (`1a02975b07854c24`).
  Email is on live contact HTML and NEWPAGES (same SSM 1093539-U). Services page still says Coming Soon.
  Draft: https://litter.catbox.moe/7onorb.html
...
4. Agent next: LES Industrial services page still says Coming Soon
   (https://www.lesindustrial.com.my/index.php?ws=servicesbycat).
