...
Updated: 2026-08-22 20:32 MYT. Success = live Stripe charge, then a payout.
...
- Micro Control: sent, no bounce yet.
- Eightfold `sale01@eightfold.com.my`: first mail + public-facts draft sent (`1a029730e3cd3e1c`).
  Email is on live homepage and contact HTML. Services page still says Coming Soon.
  Draft: https://litter.catbox.moe/u4t2wr.html
...
4. Agent next: Fabritex services page still says Coming Soon
   (https://www.fabritex.com.my/index.php?ws=servicesbycat).
   Email on live HTML: sales@fabritex.com.my. Verify again before mailing.
