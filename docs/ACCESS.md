...
Measured on this VM 2026-08-28 against public clones: Netie unittest **233 passed**; constructor (16 patches) `node --test` **36 passed**; OpenVault OpenMW (23 patches) `uv run pytest tests -q --cov=openmw.openvault --cov-fail-under=75` **912 passed, 4 skipped**. Re-probed same day: Cortex/Pointer/Space/KB/Crew/AirGPT still 404.
