...
Measured on this VM 2026-08-28 against public clones: Netie unittest **289 passed**; constructor (18 patches) `node --test` **42 passed**; OpenVault OpenMW (25 patches) routing+chat **90 passed**; prior full OpenMW suite on 23 patches was **912 passed, 4 skipped**. Re-probed same day: Cortex/Pointer/Space/KB/Crew/AirGPT still 404.
