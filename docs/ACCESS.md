...
Measured on this VM 2026-08-28 against public clones: Netie unittest **233 passed**; constructor (15 patches) `node --test` **32 passed**; OpenVault OpenMW (23 patches) `uv run pytest tests -q --cov=openmw.openvault --cov-fail-under=75` **912 passed, 4 skipped**.
