...
Filled-site batch queued (Wintools through HSA Asia). Remaining `/tmp/filled-cands.txt` without mailto or unique fact stay parked. Skip YAL remmail, Whole New Era, YHY. Do not mail.
