---
name: mengto-landing-page
description: Meng To landing-page craft. Use when designing or rewriting a high-converting single-offer landing page. Copied from https://github.com/MengTo/Skills (MIT).
---

# Source

Copied from https://github.com/MengTo/Skills/blob/main/agent-skills/web-design/landing-page/SKILL.md under MIT. Do not invent proof. Show the owner before send.
