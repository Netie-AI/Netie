"""Portable Netie contracts for product repos.
    ...
    from netie.crew import bind_deep_agent, crew_harness_profile, TokenBudget, dispatch_seat, persist, resume, register_skill, register_from_kb, mint_issue
    ...
    from netie.kb import show_brief, lookup
