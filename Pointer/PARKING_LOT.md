...
| P-002 | Windows type/hotkey/screenshot proven on hardware | Run `python -m pointer live-click` on the founder Windows laptop and attach the JSON plus a screenshot file |
