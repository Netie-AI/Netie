...
| P-002 | Windows type/hotkey/screenshot proven on hardware | Run `python -m pointer prove` on the founder Windows laptop. Unlock: `POINTER_PROVE.json` on Desktop with `"ok": true` and a screenshot path, or the same file uploaded here |
